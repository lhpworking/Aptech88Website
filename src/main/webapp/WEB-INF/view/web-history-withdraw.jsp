                                ...
                                <div class=" d-flex flex-lg-wrap flex-wrap gap-1 gap-lg-2 align-items-end m-0 ">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <button class="btn btn-secondary shadow-sm mt-2"
                                            onclick="exportData('History_withdraw_report.csv');" id="btn_export"><i
                                    ...
                                    <table class="table table-responsive table-hover table-striped " id="myTable"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Account Bank name</th>
                                            ...
                                            <tr data-bs-toggle="modal" data-bs-target="#InfoTransferModal">
                                                ...
                                                <td>
                                                 <div class="d-flex flex-column">
                                                    <h6 class="menu-method-link m-0">VietinBank</h6>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control"
                                                                                    id="floatingInput" value="VietinBank"
                                                                                    disabled
                                                                                    placeholder="name@example.com">
                                                                                <label for="floatingInput">Account Bank</label>
                                                                            </div>
                                                                        </div>
                                                                            <div class="col-6">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control"
                                                                                    id="floatingInput" value="09876765352"
                                                                                    disabled
                                                                                    placeholder="name@example.com">
                                                                        ...
                                                                        <div class="col-6">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    disabled
                                                                                    placeholder="name@example.com">
                                                                                <label for="floatingInput">Withdraw
                                                                                    amount $</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
