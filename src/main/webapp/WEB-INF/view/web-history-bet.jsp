                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control"
                                                                                    id="floatingInput" value="Manchester United vs Chelsea"
                                                                                    disabled
                                                                                    placeholder="name@example.com">
                                                                                <label for="floatingInput">Fixture</label>
                                                                            </div>
                                                                        </div>
                                                                            <div class="col-6">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control"
                                                                                    id="floatingInput" value="U @2.5"
                                                                                    disabled
                                                                                    placeholder="name@example.com">
                                                                                <label for="floatingInput">Odd</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
